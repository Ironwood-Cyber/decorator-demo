...
import type { PackageType as PackageType_1,RemoteKeys as RemoteKeys_1 } from './app2/apis.d.ts';
import type { PackageType as PackageType_2,RemoteKeys as RemoteKeys_2 } from './app3/apis.d.ts';
